...
if [ "$UPD" == "2" ]; then
set +e
bash -c "$(wget -qO - https://raw.githubusercontent.com/kabroxiko/plexupdate/master/extras/installer.sh)"
exit
fi
}
